...
export const siteConfig: SiteConfig = {
	title: "WYZの拾忆录",
	subtitle: "",
	siteURL: "https://wyz.sakura-v.cn/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		// 支持单张图片、图片数组或目录路径，当数组长度 > 1 时自动启用轮播
		src: {
			desktop: "/assets/desktop-banner", // 桌面横幅目录，会自动读取目录内全部图片
			mobile: "/assets/mobile-banner", // 移动横幅目录，会自动读取目录内全部图片
		}, // 使用本地横幅图片

		position: "center", // 等同于 object-position，仅支持 'top', 'center', 'bottom'。默认为 'center'

		carousel: {
			enable: true, // 为 true 时：为多张图片启用轮播。为 false 时：从目录中随机显示一张图片
			interval: 6, // 轮播间隔时间（秒）
		},
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: "/assets/desktop-banner", // 桌面壁纸目录，会自动读取目录内全部图片
		mobile: "/assets/mobile-banner", // 移动壁纸目录，会自动读取目录内全部图片
	}, // 使用本地横幅图片
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/WYZ-62",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "CSDN",
					url: "https://blog.csdn.net/2301_81288466",
					external: true,
					icon: "simple-icons:csdn",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Pluto52",
					external: true,
					icon: "mdi:git",
				},
				{
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/WYZ_LOGO.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "WYZ",
	bio: "整理思绪、归档知识，记录平凡日子里的成长经验。",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	title: "欢迎来到 WYZ の拾忆录", // 公告标题，填空使用i18n字符串Key.announcement
	content:
		"这里是我的私人记忆博物馆。\n我会在这里整理技术学习的点滴、记录生活中的灵光一闪，也会写下那些不想被时间冲走的随笔与感悟。愿这些文字，能成为你我共鸣的频率。", // 公告内容
	closable: false, // 欢迎卡片常驻显示
	link: {
		enable: true, // 启用链接
		text: "了解本站", // 链接文本
		url: "/about/", // 链接 URL
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "", // HTML格式的自定义页脚补充内容，默认留空
	registrations: {
		icp: {
			enable: true,
			label: "ICP备",
			text: "湘ICP备2026022908号-1",
			href: "https://beian.miit.gov.cn/",
		},
		publicSecurity: {
			enable: false, // 公安备案审核通过后再启用
			label: "公网安备",
			text: "",
			href: "",
		},
	},
	// 也可以直接编辑 FooterConfig.html 文件来添加额外自定义内容
